...
import lib_zerooff_2thre_ssim as lib
...
if len(sys.argv) < 5:
	print "usage: python training.py [TRAINING IMAGE FOLDER] [TABLE FOLDER] [RATE THRE] [PERCEPTUAL THRE]"
	exit()
	
in_folder = sys.argv[1]
lib.zerooff_thre1 = float(sys.argv[5])
lib.zerooff_thre2 = float(sys.argv[6])
